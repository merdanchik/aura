...
const CONTEXT_CHATS: Record<string, ContextChat> = {
  ...
  'mem-food':        { message: 'суши в два ночи — это уже традиция, саша',            color: '#00C896' },
  'mem-taxi':        { message: 'помню те утренние поездки — куда обычно ехал?',       color: '#FFCC00' },
  'mem-blackfriday': { message: 'чёрная пятница — взял что хотел?',                   color: '#9B6BFF' },
  'mem-travel':      { message: 'питер в июле — расскажи как было?',                  color: '#0A84FF' },
