...
const YANDEX_CONTRIBUTORS = [
  { name: 'Яндекс Маркет', role: 'поиск, корзина, сравнение, цены' },
  { name: 'Яндекс Почта',  role: 'заказы, доставка, статус' },
];

const EXT_CONTRIBUTORS = [
  { name: 'Wildberries', role: 'параллельный поиск' },
  { name: 'Ozon',        role: 'сравнение цен' },
];
