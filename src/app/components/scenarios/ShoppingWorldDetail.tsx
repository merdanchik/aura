...
const VALUES = [
  'Знает, что ты думаешь, а не импульсно покупаешь — нужен контекст, а не скидка',
  'Предложит помощь в правильный момент, когда ты уже почти решил',
  'Не пропустит ценовой момент — предупредит при изменении',
];
...
const SOURCES: Source[] = [
  {
    iconSrc: svcMarket,
    name:    'Яндекс Маркет',
    facts:   '8 возвратов к товару за неделю, 3 в корзине, 12 сравнений',
    meaning: 'Обдуманный выбор — не импульс',
    accent:  COLOR,
  },
  {
    initials: '✉',
    name:     'Яндекс Почта',
    facts:    'История заказов и статусы доставки',
    meaning:  'Контекст предыдущих покупок',
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <p style={{ color: '#fff', fontSize: 18, fontWeight: 700, lineHeight: 1.1 }}>Шопинг</p>
          <p style={{ color: 'rgba(255,255,255,0.38)', fontSize: 13, marginTop: 2 }}>Поиск · Сравнение · Решение</p>
        </div>
